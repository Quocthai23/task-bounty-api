...
export class WalletsService {
  ...
  constructor(
    ...
    this.contractAddresses = {
      VND: this.configService.get<string>('CONTRACT_ADDRESS_VND') || this.configService.get<string>('CONTRACT_ADDRESS') || '0xe7f1725e7734ce288f8367e1bb143e90bb3f0512',
      USD: this.configService.get<string>('CONTRACT_ADDRESS_USD') || '0x9fe46736679d2d9a65f0992f2272de9f3c7fa6e0',
      EUR: this.configService.get<string>('CONTRACT_ADDRESS_EUR') || '0xcf7ed3acca5a467e9e704c703e8d87f634fb0fc9',
      JPY: this.configService.get<string>('CONTRACT_ADDRESS_JPY') || '0xdc64a140aa3e981100a9beca4e685f962f0cf6c9',
      CNY: this.configService.get<string>('CONTRACT_ADDRESS_CNY') || '0x5fc8d32690cc91d4c39d9d3abcbd16989f875707',
    };
  }
